...
if (num2>num3)
{
    ...
    {
        Console.WriteLine("Число " + num2 + " самое большое, а число " + num3 + " самое меньшее");
    }
}

// !!!Программа не выдает ошибку и не выдает результат при вводе отрицательного числа первым. Во всех остальных случаях работает!!!
*/
